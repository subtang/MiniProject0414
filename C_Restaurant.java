...
public class C_Restaurant {
	...
	public static void addRestaurant(List<C_Restaurant> restaurantList, String filename) {
		...
		String RemenuName = scanner.nextLine();
		...
		C_Restaurant restaurant = new C_Restaurant();
	...
	private static void saveRestaurants(String filename, List<C_Restaurant> restaurantList) {
